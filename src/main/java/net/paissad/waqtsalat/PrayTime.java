...
public class PrayTime {
    ...
    private int                        asrJuristic;       // Juristic method
                                                           // for Asr
    private int                        dhuhrMinutes;      // minutes after
                                                           // mid-day for Dhuhr
    private int                        adjustHighLats;    // adjusting method
                                                           // for higher
                                                           // latitudes
    ...
    private int                        Karachi;           // University of
                                                           // Islamic Sciences,
                                                           // Karachi
    private int                        ISNA;              // Islamic Society of
                                                           // North America
                                                           // (ISNA)
    private int                        MWL;               // Muslim World
                                                           // League (MWL)
    private int                        Makkah;            // Umm al-Qura,
                                                           // Makkah
    private int                        Egypt;             // Egyptian General
                                                           // Authority of
                                                           // Survey
    private int                        Custom;            // Custom Setting
    private int                        Tehran;            // Institute of
                                                           // Geophysics,
                                                           // University of
                                                           // Tehran
    // Juristic Methods
    ...
    private int                        AngleBased;        // angle/60th of
                                                           // night
    // Time Formats
    private int                        Time24;            // 24-hour format
    private int                        Time12;            // 12-hour format
    private int                        Time12NS;          // 12-hour format
                                                           // with no suffix
    private int                        Floating;          // floating point
                                                           // number
    private String                     InvalidTime;       // The string used
                                                           // for invalid times
    // --------------------- Technical Settings --------------------
    private int                        numIterations;     // number of
                                                           // iterations needed
                                                           // to compute times
     ...
     * @param longitude
     * @param tZone
     * @return An <code>ArrayList</code> containing the pray times.
     */
