...
/**
 * Class Messages provides a mechanism to localise the text messages found in WaqtSalat.<br>
...
public class Messages {
	...
	private static final String BUNDLE_NAME = "net.waqtsalat.i18n.messages";
