	...
	public SysTray() throws AWTException {
		...
		if (!SystemTray.isSupported()) {
			...
			for (int i=0; i<prayNames.length; i++) {
				...
				//JRadioButtonMenuItem prayItem = new JRadioButtonMenuItem(pn.getName(), false);
			...
			//JOptionPane.showOptionDialog(null, "Message", "Title", JOptionPane.NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, null, null);
