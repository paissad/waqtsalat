...
/**
 * Parse command line and retrieve options correctly.
 * 
...
public class WsParseCommandLine {
    ...
    private CmdLineParser.Option       confFileNameOpt;
    /*
     * If we want to compute automatically the prayers time without specifying
     * anything.
     */
    private CmdLineParser.Option       automaticOpt;
    private CmdLineParser.Option       latOpt;
    private CmdLineParser.Option       longOpt;
    private CmdLineParser.Option       ipOpt;
    ...
    public WsParseCommandLine(String[] args) {
        ...
        try {
            ...
            /*
             * _confFileName will get default value "waqtsalat.conf" if
             * _confFileName has a previous null value.
             */
